        ...
        <Container>
            <View className='flex-1 justify-center items-center'>
                ...
                <View className='gap-2 mb-2'>
                    <Text className='font-boldSFDisplay text-base text-center' >Oops! This page is missing.</Text>
                    <Text className='text-center font-regularSFDisplay text-sm' >
                        Looks like you found a page that doesn&apos;t exist yet. It&apos;s probably taking a nap 💤.
                    </Text>
                </View>
                <TouchableOpacity onPress={() => router.replace('/(home)')}>
                    <View className='py-4 rounded-xl bg-[#317BFF] px-6'>
                        <Text className='text-white font-boldSFDisplay text-sm'>Go back to home</Text>
                    </View>
                </TouchableOpacity>
