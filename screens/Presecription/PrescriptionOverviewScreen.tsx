...
const PrescriptionOverviewScreen = () => {
    ...
    return (
        <>
            {!clickPrescription && <LinearGradient colors={['#ECE7F6', '#EBE8F8', '#E4EFFF', '#FAF1E2']} style={{ flex: 1 }} start={{ x: 1, y: 0 }} end={{ x: 0, y: 1 }} >
                <Container bg='transparent'>
                    ...
                    <View className='flex-1 justify-center items-center'>
                        <View
                            className='bg-white border border-[#E8F3FF] rounded-xl py-6 px-7  justify-center items-center'
                        >
            ...
            {
                clickPrescription && <Container bg={'white'} px='px-0'>
