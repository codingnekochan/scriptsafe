...
import { comorboditiesOption, genderOptions } from '@/constants/contentProps'
import { router } from 'expo-router'
import React from 'react'
import { Text, View } from 'react-native'

const StepOneScreen = ({ pregnancyOptions, handleChange, state, combordities, lifestyle, handleNext,error }: any) => {
